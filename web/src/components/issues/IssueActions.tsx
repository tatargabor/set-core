...
const BUTTON_CONFIG: Record<string, { label: string; className: string; confirm?: string }> = {
  ...
  dismiss:          { label: '✕ Dismiss',           className: 'bg-surface-strong/50 text-fg-muted hover:bg-surface-strong', confirm: 'Dismiss this issue? It will be marked as won\'t-fix.' },
  cancel:           { label: '⊘ Cancel',            className: 'bg-surface-strong/50 text-fg-muted hover:bg-surface-strong', confirm: 'Cancel in-progress work on this issue?' },
  skip:             { label: '→ Skip',              className: 'bg-surface-strong/50 text-fg-muted hover:bg-surface-strong' },
  mute:             { label: '🔇 Mute',             className: 'bg-surface-strong/50 text-fg-muted hover:bg-surface-strong' },
