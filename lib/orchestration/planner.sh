...
#
# auto_replan_cycle() runs in Python via engine.py (called from Python monitor loop).
# cmd_plan() remains for CLI use (wt-orchestrate plan).
...
# No bash implementation needed — the Python monitor loop handles replanning directly.
