...
class ExtraFormatter(logging.Formatter):
    ...
    Example:
        ...
        → "2026-03-14T10:00:00 INFO wt_orch.config:parse_directives dispatch_change change=add-auth attempt=2"
    """
...
def setup_logging(
    ...
    """Configure logging for all wt_orch modules.
    ...
    Returns the root 'wt_orch' logger.
    """
    ...
    # Root logger for all wt_orch modules
    root_logger = logging.getLogger("wt_orch")
