...
- **fixed when:** the user's failing step is reproduced in the named environment and the offending layer is fixed or the report is narrowed to a defect elsewhere (e.g. a different surface than `FleetTerminal`).
