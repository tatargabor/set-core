# Spec: TUI Design System

### IN SCOPE
- Global monospace font override
- Font size normalization (3-tier: xs, sm, base)
- Removal of all font-mono classes
...
### OUT OF SCOPE
- Changing the color palette (neutral/blue/green/red/yellow works well)
- Redesigning page layouts or navigation structure
- Adding new pages or features
- Changing the Battle tab (already has its own style)
- Adding web fonts (use system monospace stack)
