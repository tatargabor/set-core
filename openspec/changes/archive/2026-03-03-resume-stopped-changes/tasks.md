...
- [x] 1.1 Add `resume_stopped_changes()` function in `bin/set-orchestrate` — iterates changes with status "stopped", checks worktree exists, calls `resume_change()` or sets "pending"
