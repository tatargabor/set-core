## IN SCOPE
- Rendering a project's answers by shape rather than by field name
- The honesty rules the screen must not break
- Declaration-driven mechanisms: row actions, emphasis, section ranking, deprecation
- Compaction that is not concealment

## OUT OF SCOPE
- Any project's vocabulary, in any language
- Interpreting a value's meaning, or ranking values by importance
