## IN SCOPE
- Which commands a page load runs, and what a caller may ask for by name
- Guards between a URL-supplied name and `subprocess`
- The in-memory answer cache and its prohibitions
- The write endpoint and what it refuses
- Reporting gaps as gaps in the response

## OUT OF SCOPE
- Envelope semantics (see `project-status-contract`)
- Any rendering decision (see `project-status-surface`)
