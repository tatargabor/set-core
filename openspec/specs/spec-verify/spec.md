## IN SCOPE
- Classify spec_verify invocations into LLM verdict vs infrastructure vs ambiguous
- Retry once with doubled max-turns on infrastructure failure
- Emit GATE_INFRA_FAIL for unrecoverable infrastructure issues
- Retry context with verification output on explicit FAIL
