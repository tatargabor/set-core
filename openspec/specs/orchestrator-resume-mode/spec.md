...
When `set-orchestrate start` is called and a state file exists with active changes (running, pending, verifying, stalled, dispatched), skip digest/planning and go directly to the monitor loop.
