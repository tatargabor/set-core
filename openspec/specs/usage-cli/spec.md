...
## Purpose
Provide CLI access to Claude token usage data via the `wt-usage` command, with time range selection, cost estimation, and session key management.
