# agent-provider-start Specification

## Purpose
Naming a provider and a model when starting an agent, delivering the resolved environment, and recording what it ran on.
