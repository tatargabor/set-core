...
Resolve conflicts during integration by applying file-protection strategies returned by the active project profile (e.g., theirs-wins for lockfiles, ours-wins for schema files). When the profile defines no strategies, default merge behavior is preserved.
## Requirements
